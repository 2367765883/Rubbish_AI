<template>
	<view class="container">
		<view class="ui-all">
			...
			<view class="ui-list">
				<text>手机号</text>
				<input  type="number" :placeholder="value" :value="mobile" @input="bindmobile" placeholder-class="place" />
			</view>
				 ...
				 let that = this
				     uni.getUserProfile({
				         ...
				         success: (res1) => {
				             ...
				             this.avater = that.info.avatarUrl;
							 this.nickName=that.info.nickName
							 console.log(res1)
				             uni.showToast({
				                 icon:"none",
				                 title:'获取成功'
